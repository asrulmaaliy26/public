        ...
        <div class="shadow p-4 rounded" style="background-color: white;">
            ...
            <form method="POST" action="" class="mt-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subject" name="subject" class="form-control mt-2" required>
                </div>
                <div class="form-group">
                    <label for="message">Message:</label>
                    <textarea id="message" name="message" class="form-control mt-2" rows="4" required></textarea>
                </div>
