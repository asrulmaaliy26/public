...
<html lang="en">
    <head>
        <title>Ma Alhidayah</title>
        <link rel="icon" type="image/x-icon" href="assets/logoma.png">
        <meta charset="utf-8">
    ...
    <body>
        <nav class="navigation">
            <a href="https://hpanel.hostinger.com" rel="nofollow" target="_blank">
                <img style="width: 60px;" src="assets/images/logoma.png" alt="">
            </a>
            <h1 style="color: white;">MA Al - Hidayah</h1>
        </nav>
        <div class="content">
            <svg 
                class="main-image"
                ...
                <path d="M52.3747 171.744H39V184.277H52.3747V171.744Z" fill="#14756D"/>
                <path d="M611.682 88.573H598.307V102.245H611.682V88.573Z" fill="#14756D"/>
                <path d="M384.311 173.864C397.176 197.034 424.878 208.367 449.522 201.798C470.052 196.291 485.552 179.079 488.877 158.072" stroke="#14756D" stroke-width="18" stroke-miterlimit="10"/>
                <path d="M569.199 264.276L517.516 232.922L484.055 281.351L535.738 312.705L569.199 264.276Z" fill="#14756D"/>
